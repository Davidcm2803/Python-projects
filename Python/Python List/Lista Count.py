...
valorAAgregar = input("Favor ingrese el siguiente mes a agregar: ")
print(instanciaAno.agregarValorALista(instanciaAno,instanciaAno.listadoMes,valorAAgregar))
elementoAContar = input("Indique el mes que desea verificar cuantas veces existe en la lista: ")
print("El elemento: " + elementoAContar + " , existe: ", instanciaAno.listadoMes.count(elementoAContar), "veces.")